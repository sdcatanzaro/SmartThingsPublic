...
definition(
  ...
  namespace: "sdcatanzaro",
  author: "redloro@gmail.com",
  description: "Honeywell Security SmartApp",
  category: "My Apps",
  iconUrl: "https://raw.githubusercontent.com/sdcatanzaro/images/master/honeywell-security.png",
  iconX2Url: "https://raw.githubusercontent.com/sdcatanzaro/images/master/honeywell-security.png",
  iconX3Url: "https://raw.githubusercontent.com/sdcatanzaro/images/master/honeywell-security.png",
  singleInstance: true
)
...
private addChildDevices(partitions, zones) {
  partitions.each {
    ...
    if (!getChildDevice(deviceId)) {
      addChildDevice("sdcatanzaro", "Honeywell Partition", deviceId, hostHub.id, ["name": "Honeywell Security", label: "Honeywell Security", completedSetup: true])
  ...
  zones.each {
    ...
    if (!getChildDevice(deviceId)) {
      ...
      addChildDevice("sdcatanzaro", "Honeywell Zone "+it.type, deviceId, hostHub.id, ["name": it.name, label: it.name, completedSetup: true])
